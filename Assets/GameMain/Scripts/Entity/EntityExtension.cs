...
namespace StarForce
{
    public static class EntityExtension
    {
        ...
        public static void ShowMapGrid(this EntityComponent entityComponent, MapGridData data)
        {
            entityComponent.ShowEntity(typeof(MapGrid), "Map", Constant.AssetPriority.MapAsset, data);
        }
